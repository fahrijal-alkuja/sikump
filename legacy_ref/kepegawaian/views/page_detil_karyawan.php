...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="alert alert-danger" role="alert">
            Data Kepegawaian diisi dengan data SK Pengangkatan Karyawan Tetap Dari Yayasan ! bukan SK Stuktural !
        </div>
        <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kepegawaian/updateKeluarga') ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="modal_edit_kepegawaian<?= $kar['nik'] ?>" tabindex=" -1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kepegawaian/update_kepegawaian') ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal_edit_kependudukan<?= $kar['nik'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kepegawaian/updateKependudukan') ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal_edit_profil<?= $kar['nik'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kepegawaian/updateProfil') ?>" method="POST" enctype="multipart/form-data">
						<div class="form-group">
                            <label for="formGroupExampleInput2">NIK</label>
                            <input type="text" value="<?= $kar['nik']; ?>" name="nik1" class="form-control" id="nik1" placeholder="nik">
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal_edit_foto<?= $kar['nik'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kepegawaian/update_poto_profil') ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal_edit_npwp<?= $kar['nik'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kepegawaian/update_pajak') ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
