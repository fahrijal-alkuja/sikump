                    ...
                    <tbody>
                        <?php foreach ($riwayat as $pen) : ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger tombol-hapus" href="<?= base_url('pelatihan_karyawan/delete') ?>/<?= $pen['id'] ?>"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('pelatihan_karyawan/insert_pelatihan') ?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="modal_upload<?= $id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('pelatihan_karyawan/upload_sertifikat') ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
