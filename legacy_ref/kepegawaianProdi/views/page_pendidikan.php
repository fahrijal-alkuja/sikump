                    ...
                    <tbody>
                        <?php foreach ($riwayat as $pen) : ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger tombol-hapus" href="<?= base_url('kepegawaianProdi/delete') ?>/<?= $pen['id'] ?>"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('kepegawaianProdi/insert_pendidikan') ?>" method="POST">
...
<?php foreach ($riwayat as $pen) : ?>
    <div class="modal fade" id="modal_edit_ijazah<?= $pen['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kepegawaianProdi/upload_ijazah') ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Upload Ijazah</label>
                            <input type="hidden" value="<?= $pen['id'] ?>" name="id" class="form-control" id="id" placeholder="nik ">
                            <input type="hidden" value="<?= $pen['nik'] ?>" name="nik" class="form-control" id="id" placeholder="nik ">
